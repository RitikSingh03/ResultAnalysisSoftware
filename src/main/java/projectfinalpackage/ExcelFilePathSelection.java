...
public class ExcelFilePathSelection {
    public static String excelFilePathSelection() {
        ...
        panel.add(new JLabel("Enter the Path where the excel file will be created: "));
        panel.add(textField);
