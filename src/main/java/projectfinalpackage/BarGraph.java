...
//            String title
//    ) throws Exception {
//boolean permission=WordPermissionChecker.hasWritePermission(existingWordFilePath);
//if(permission) {
...
//
//        document.close();
//    	javax.swing.JOptionPane.showMessageDialog(null, new javax.swing.JPanel(), "Graph is created", javax.swing.JOptionPane.PLAIN_MESSAGE);
//
//    }
//else {
//	javax.swing.JOptionPane.showMessageDialog(null, new javax.swing.JPanel(), "File Write Permission not there ", javax.swing.JOptionPane.PLAIN_MESSAGE);
//
//}
//    }
//
    ...
    public static void createGraph(
        ...
        if (permission) {
            ...
            for (int i = 0; i < passPercentPerSubjectList.size(); i++) {
                ...
                String subject = subjectList.get(i);
//                dataset.addValue(passPercent, "Pass Percentage", subject);
                dataset.addValue(passPercent, title, subject);
            ...
            try (FileInputStream inputStream = new FileInputStream(chartFile)) {
                XWPFRun imgRun = paragraph.createRun();
                imgRun.addPicture(inputStream, Document.PICTURE_TYPE_PNG, chartFile.getAbsolutePath(), Units.toEMU(400), Units.toEMU(300));
            }
